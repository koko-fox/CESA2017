    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float4 node_5839 = _Time + _TimeEditor;
                float2 node_2283 = (o.uv0+node_5839.g*float2(0.5,0.5));
...
/// Final Color:
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                float2 node_2283 = (o.uv0+node_6302.g*float2(0.5,0.5));
                float node_909 = (saturate((1.0-(1.0-sin((node_2283.r*_Frequency)))*(1.0-sin((node_2283.g*_Frequency)))))/_DivideIntensity);
                v.vertex.xyz += float3(node_909,node_909,node_909);
                o.pos = mul(UNITY_MATRIX_MVP, v.vertex );
